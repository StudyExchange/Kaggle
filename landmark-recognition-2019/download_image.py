...
def loader():
    ...
    pool = multiprocessing.Pool(processes=cpu_amount)  # Num of CPUs
...
# python download_image.py ./input/train.csv ./input/org_train
# python download_image.py ./input/test.csv ./input/org_test
