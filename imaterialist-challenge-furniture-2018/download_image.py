...
#    response = request.urlopen(url, 10)
...
# python download_image.py ./input/validation.json ./input/org_val
# python download_image.py ./input/test.json ./input/org_test
# python download_image.py ./input/train.json ./input/org_train
